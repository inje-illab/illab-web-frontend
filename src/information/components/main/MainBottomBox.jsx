...
const MainBottomBox = () => {
    ...
    return (
        <div className="grid grid-cols-3 gap-5 items-center max-w-5xl m-auto">
            {activityContents.map((activityContent, index) => (<div key={index} className="shadow-xl rounded-lg text-center p-7">
                <div>
