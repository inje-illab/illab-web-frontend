    ...
    return (
        <div className="p-5 max-w-5xl m-auto">
            {middleContentDatas.map((contentData, index) => (
                <div key={index} className="grid grid-cols-3 my-10">
                    <div className={classNames("text-center text-3xl italic flex items-center justify-center rounded-lg border-[1px] ", contentData.borderClass)}>
                    ...
                    <div className="col-span-2 pl-5 pt-3">
                        ...
                        <div className="text-gray-300 italic">{contentData.descriptionUS}</div>
                        <div className='pt-4'>
